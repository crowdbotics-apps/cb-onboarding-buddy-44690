...
## Project Structure
    ...
    ├── cb_onboarding_buddy_44690  # Django project configurations
...
1. Clone this repo and `cd cb_onboarding_buddy_44690`
...
2. Clone this repo and `cd cb_onboarding_buddy_44690`
